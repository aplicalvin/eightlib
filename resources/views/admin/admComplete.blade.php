<x-admLayout>
    ...
    <div class="grid gap-2 md:gap-4">
        <h1 class="text-xl md:text-3xl font-bold">Konfirmasi Pengembalian Buku</h1>
        <hr />
    </div>
                    ...
                    <tbody>
                        <template x-for="user in users" :key="user.name">
                            <tr>
                                ...
                                <!-- Tolak / Terima -->
                                <td
                                    class="block md:flex border-dashed border-t border-stone-200 blankSpace"
                                >
                                    <span
                                        class="text-stone-700 px-3 py-3 flex items-center"
                                    >
                                        <a
                                            href="#"
                                            class="hover:underline text-stone-100 bg-green-700 hover:bg-green-800 px-2.5 py-1 rounded-md"
                                            type="button"
                                        >
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    >
                                        <a
                                            href="#"
                                            class="hover:underline text-stone-100 bg-red-600 hover:bg-red-700 px-2.5 py-1 rounded-md"
                                            type="button"
                                        >
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
